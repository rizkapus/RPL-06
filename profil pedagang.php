...
<body>
	...
	<center><h1 style="color:black; font-family:'rockwell'">Profil Pedagang</h1> </center>
	<br>
	
	<div class="panel">
		
		<header class="head">
			<img class="profil" src="khadijah.jpg">
		...
		<aside class="side1">
			...
			<h2>About me</h2>
			<ul>
				<li><img src="irumah.png">Alamat : Prada<img class="editt" src ="edit.png"></li>
				<li><img src="istudy.jpg">Umur   : 35<img class="editt" src="edit.png"></li>
				<li><img src="ilove.png">Status  : menikah<img class="editt" src="edit.png"></li>
				<li><img src="gender.png">Gender : Wanita<img class="editt" src="edit.png"></li>
				<li><img src="email.png">Email  : kj@gmail.com<img class="editt" src="edit.png"></li>
			</ul>
		</aside>
