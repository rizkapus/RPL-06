...
<body>
	...
	<center><h1 style="color:black; font-family:'rockwell'">Profil Kurir</h1> </center>
	<br>
	
	<div class="panel">
		
		<header class="head">
			<img class="profil" src="kurir.png">
		...
		<aside class="side1">
			...
			<h2>About me</h2>
			<ul>
				<li><img src="irumah.png">Alamat : Peunayong<img class="editt" src ="edit.png"></li>
				...
				<li><img src="email.png">Email  : a@gmail.com<img class="editt" src="edit.png"></li>
			</ul>
		</aside>
