...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div>
				<h3 class="pull-right">Rp. 30.000/kg</h3>
				<h1>Lada Bubuk</h1>
					<div class="ratings">
						<p>
						...
						<div class="col-md-4">
							<img src="img\ladabubuk.jpg" width="300" alt="">
						</div>	
    ...
    <script src="js/bootstrap.min.js"></script>
	 ...
	 <script>
		function jumlah(){
			var harga = document.getElementById("sel1").value*30000
