...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div>
				<h3 class="pull-right">Rp. 45.000/ekor</h3>
				<h1>Ayam Potong</h1>
					<div class="ratings">
						<p>
						...
						<div class="col-md-4">
							<img src="img\ayampotong1.jpg" width="300" alt="">
						</div>	
    ...
    <script src="js/bootstrap.min.js"></script>
	 ...
	 <script>
		function jumlah(){
			var harga = document.getElementById("sel1").value*45000
