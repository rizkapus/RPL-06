...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div>
				<h3 class="pull-right">Rp.80.000/kg</h3>
				<h1>Daging Sapi</h1>
					<div class="ratings">
						<p>
						...
						<div class="col-md-4">
							<img src="img\dagingsapi.jpg" width="300" alt="">
						</div>	
    ...
    <script src="js/bootstrap.min.js"></script>
	 ...
	 <script>
		function jumlah(){
			var harga = document.getElementById("sel1").value*80000
